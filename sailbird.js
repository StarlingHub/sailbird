...
const canvas = document.getElementById('particles');
    ...
    const colors = ['#0055ff', '#a0e7e5', '#b4f8c8', '#fbe7c6', '#ff6000', '#ffb600', '#ff00aa'];
    ...
    function animate() {
     ...
     // Detect screen width for particle amount
    if(window.innerWidth < 768) {
      initParticles(20); // fewer dots on phones
    } else {
      initParticles(65); // normal amount on larger screens
    }
